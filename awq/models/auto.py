...
class AutoAWQForCausalLM:
    ...
    @classmethod
    def from_pretrained(cls, model_path, trust_remote_code=True, safetensors=False) -> BaseAWQForCausalLM:
    ...
    @classmethod
    def from_quantized(cls, quant_path, quant_filename='', max_new_tokens=None, device='balanced', trust_remote_code=True, fuse_layers=True, batch_size=1, safetensors=False) -> BaseAWQForCausalLM:
